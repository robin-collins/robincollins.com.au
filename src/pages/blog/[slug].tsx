...
const BlogDetailPage: NextPage<BlogDetailPageProps> = ({ blog }) => {
  ...
  const canonicalUrl = `https://robincollins.com.au/${slug}`;
  ...
  return (
    <>
      <NextSeo
        title={`${blogData?.title?.rendered} - Blog Robin Collins`}
        ...
        openGraph={{
          ...
          article: {
            ...
            authors: ['Robin Collins', 'robin-collins'],
          },
          url: canonicalUrl,
          images: [
            {
