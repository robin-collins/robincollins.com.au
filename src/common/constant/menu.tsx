...
export const SOCIAL_MEDIA: MenuItemProps[] = [
  {
    title: 'Email',
    href: 'mailto:robin.f.collins@outlook.com',
  ...
  {
    title: 'Linkedin',
    href: 'https://www.linkedin.com/in/robin-collins-sa/',
  ...
  {
    title: 'Twitter',
    href: 'https://twitter.com/RobinFCollins',
  ...
  {
    title: 'Github',
    href: 'https://github.com/robin-collins',
...
export const EXTERNAL_LINKS: MenuItemProps[] = [
  {
    title: 'Analytics',
    href: 'https://analytics.teamcollins.net/share/nKQvr7GFojWZdZVZ/teamcollins.net',
